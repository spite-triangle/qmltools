...
namespace QmlJS {
    ...
    typedef QSharedPointer<QTextDocument> QTextDocumentPtr;
...
public: // attributes
    ...
    static SemanticInfo makeNewSemanticInfo(const Document::Ptr &doc, const Snapshot &snapshot,QTextDocumentPtr qdoc);
...
Q_DECLARE_METATYPE(QmlJS::SemanticInfo)
