...
void StackFrame::fixQrcFrame(const FilePath & projectSourceDirectory)
{
    ...
    FilePath absFile = findFile(projectSourceDirectory, relativeFile);
    if (absFile.isEmpty())
